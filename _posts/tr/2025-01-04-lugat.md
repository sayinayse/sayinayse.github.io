...
Yine de, bu yapılan işlerin bir küme eşleme işlemi (yabancı diller kümesinden Türkçe dil kümesine) olduğunu gözetince, hâlâ yapılacak işler olduğu kanısındayım. Çünkü terimlerin Türkçe karşılığının bulunması onların kullanışlılık ve kapsamlılığını test etmeye yeterli olmuyor. Bu terimlerin bağlam içerisinde sınanmasası ve doğal bir kullanıma evrilmesinin de bu çalışmaların bir devamı olarak görüyorum.   
