...
| tradeoff            |  al-ver dengesi /ödünleşim     |
...
| reverse shell connection          | <span class="hover-term" data-tooltip="reverse shell bağlantısı?teke portlatması?">???</span>                   |
...
| frequency scrambling       | frekans karıştırma           |
...
| time to live (ttl)                       | yaşama süresi                    |
...
| frequency division multiple access (fdma) | frekans bölümlü çoklu erişim            |
| time division multiple access (tdma) | zaman bölümlü çoklu erişim            |
| code division multiple access (cdma) | kod bölümlü çoklu erişim            |
| paging                                  | sayfalama                             |
...
| line of sight                     | doğrudan görüş hattı          |
| diffraction                   | kırınım               |
| delay spread                |       gecikme yayılımı    |
|  coherent bandwidth         | uyumlu bant genişliği       |
| interference loss             | girişim kaybı     |
| large scale fading          | geniş ölçekte sönümleme  |
| small scale fading          | dar ölçekte sönümleme  |
| uplink          | yukarı yönlü kanal  |
| downlink          | aşağı yönlü kanal  |
| analog modulation          | analog modülasyon  |